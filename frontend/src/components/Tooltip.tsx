  ...
  return (
    ...
    >
      ...
      {visible &&
        (() => {
          const baseClasses =
            'fixed z-50 px-2.5 py-1.5 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 shadow-md text-zinc-950 dark:text-zinc-100 text-xs rounded-lg whitespace-nowrap pointer-events-none';
          return (
            <div
