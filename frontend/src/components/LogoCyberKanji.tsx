export function LogoCyberKanji() {
  return (
    <svg viewBox="0 0 32 32" className="w-8 h-8" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g filter="url(#glow)">
        {/* Horizontal lines */}
        <path d="M8 10H24" stroke="url(#cyberKanjiGradient)" strokeWidth="2" strokeLinecap="round" />
        <path d="M8 16H24" stroke="url(#cyberKanjiGradient)" strokeWidth="2" strokeLinecap="round" />
        <path d="M8 22H24" stroke="url(#cyberKanjiGradient)" strokeWidth="2" strokeLinecap="round" />
        {/* Vertical line */}
        <path d="M16 8V24" stroke="url(#cyberKanjiGradient)" strokeWidth="2" strokeLinecap="round" />
        {/* Cyber accents */}
