          ...
          <div className="flex flex-wrap justify-center items-center gap-x-3 gap-y-1 text-sm text-zinc-500 dark:text-zinc-400 justify-self-center">
            {[...projectLinks, ...legalLinks].map((link) => (
              <Link
                key={link.href}
                to={link.href}
                className="hover:text-zinc-950 dark:hover:text-zinc-100 whitespace-nowrap"
              >
                {link.label}
              </Link>
            ))}
          </div>
          <span className="text-sm text-zinc-500 dark:text-zinc-400 justify-self-center md:justify-self-end">
            © 2026 Nohonu
          </span>
        </div>
      </div>
