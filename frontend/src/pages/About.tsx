  ...
  return (
    <div className="max-w-7xl mx-auto px-6">
      <header className="pt-12 pb-8">
        ...
        <p className="text-base text-zinc-500 dark:text-zinc-400">Open-source platform for deploying and discovering static sites.</p>
      </header>
      ...
      <section className="py-8">
        ...
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
          Upload a zip archive or connect a GitHub repository, and Nohonu serves the
          contents on a subdomain. Every deploy creates a new version, so you can
          roll back to any previous state at any time. You can also bring your own
          custom domain — verify ownership with a DNS record and your site is live.
        </p>
      </section>
      ...
      <section className="py-8">
        ...
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
          Most hosting platforms are closed source and tie you to a single provider.
          Nohonu is open source (AGPL-3.0) and self-hostable — you own your
          infrastructure and your data. No vendor lock-in, no databases to manage,
          no opaque pricing. Just static sites, served your way.
        </p>
      </section>
      ...
      <section className="py-8">
        ...
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
          Developers, designers, hobbyists, students — anyone who wants to put
          static content on the web without managing servers or configuration. If
          you can zip a folder or push to GitHub, you can use Nohonu.
        </p>
      </section>
    </div>
  );
