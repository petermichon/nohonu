    ...
    <div className="space-y-8">
      ...
      <div className="space-y-8 text-sm text-stone-600 dark:text-stone-400 leading-relaxed">
        <section id="introduction">
          <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-3">1. Introduction</h2>
          <p>
        ...
        <section id="information-we-collect">
          <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-3">2. Information We Collect</h2>
          <p className="mb-3">We may collect the following types of information:</p>
          <ul className="list-disc pl-5 space-y-1.5">
            <li>
              <strong className="text-stone-700 dark:text-stone-300">Account Information</strong> — email address, name,
              and authentication credentials when you create an account.
            </li>
            <li>
              <strong className="text-stone-700 dark:text-stone-300">Usage Data</strong> — information about how you
              interact with our platform, including pages visited, features used, and timestamps.
            </li>
            <li>
              <strong className="text-stone-700 dark:text-stone-300">Technical Data</strong> — IP address, browser type,
              operating system, and device information collected automatically.
            </li>
            <li>
              <strong className="text-stone-700 dark:text-stone-300">Deployed Content</strong> — files and data you
        ...
        <section id="data-sharing">
          <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-3">4. Data Sharing</h2>
          <p>
        ...
        <section id="data-retention">
          <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-3">5. Data Retention</h2>
          <p>
        ...
        <section id="your-rights">
          <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-3">7. Your Rights</h2>
        ...
        <section id="security">
          <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-3">8. Security</h2>
          <p>
        ...
        <section id="childrens-privacy">
          <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-3">9. Children's Privacy</h2>
          <p>
        ...
        <section id="changes">
          <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-3">10. Changes to This Policy</h2>
          <p>
        ...
        <section id="contact">
          <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-3">11. Contact Us</h2>
          <p>
