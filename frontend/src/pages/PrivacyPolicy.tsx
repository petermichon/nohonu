...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-7xl mx-auto space-y-8 px-6 pt-12">
      ...
      <div>
        <h1 className="text-3xl font-semibold text-zinc-950 dark:text-zinc-100 mb-2">Privacy Policy</h1>
      ...
      <div className="space-y-8 text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
        <section id="introduction">
          <h2 className="text-lg font-semibold text-zinc-950 dark:text-zinc-100 mb-3">1. Introduction</h2>
          <p>
        ...
        <section id="information-we-collect">
          <h2 className="text-lg font-semibold text-zinc-950 dark:text-zinc-100 mb-3">2. Information We Collect</h2>
        ...
        <section id="data-sharing">
          <h2 className="text-lg font-semibold text-zinc-950 dark:text-zinc-100 mb-3">4. Data Sharing</h2>
          <p>
        ...
        <section id="data-retention">
          <h2 className="text-lg font-semibold text-zinc-950 dark:text-zinc-100 mb-3">5. Data Retention</h2>
          <p>
        ...
        <section id="your-rights">
          <h2 className="text-lg font-semibold text-zinc-950 dark:text-zinc-100 mb-3">7. Your Rights</h2>
        ...
        <section id="security">
          <h2 className="text-lg font-semibold text-zinc-950 dark:text-zinc-100 mb-3">8. Security</h2>
          <p>
        ...
        <section id="childrens-privacy">
          <h2 className="text-lg font-semibold text-zinc-950 dark:text-zinc-100 mb-3">9. Children's Privacy</h2>
          <p>
        ...
        <section id="changes">
          <h2 className="text-lg font-semibold text-zinc-950 dark:text-zinc-100 mb-3">10. Changes to This Policy</h2>
          <p>
        ...
        <section id="contact">
          <h2 className="text-lg font-semibold text-zinc-950 dark:text-zinc-100 mb-3">11. Contact Us</h2>
          <p>
