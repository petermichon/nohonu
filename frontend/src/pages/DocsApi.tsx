  ...
  return (
    <div>
      ...
      <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-8">
        All API requests require authentication via session cookie or API key. The base URL is
        the root of your Nohonu instance.
      </p>
      ...
      <section className="py-8 space-y-4">
        ...
        <Endpoints rows={[
          ...
          { method: 'POST', path: '/sites/:domain/versions/:ts/github', desc: 'Fetch from GitHub and create version' },
      ...
      <section className="py-8 space-y-4">
        ...
        <Endpoints rows={[
          { method: 'GET', path: '/explore/sites', desc: 'Browse publicly discoverable sites' },
        ]} />
      </section>
