      ...
      <section>
        ...
        <header className="relative max-w-7xl mx-auto px-6 pt-24 pb-16">
          ...
          <div className="relative max-w-2xl">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                to="/docs"
                className="px-4 h-[46px] rounded-full text-sm font-medium text-zinc-950 dark:text-zinc-100 bg-zinc-50 dark:bg-zinc-950 hover:bg-zinc-100 dark:hover:bg-zinc-900 cursor-pointer border border-zinc-200 dark:border-zinc-800 whitespace-nowrap flex items-center justify-center gap-2"
              >
        ...
        <section className="max-w-7xl mx-auto px-6 py-8">
          ...
          {!loading && !error && sites.length > 0 && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
              {sites.map((site) => (
                <HomeSiteCard key={site.siteId} site={site} />
              ))}
            </div>
          )}
        </section>
