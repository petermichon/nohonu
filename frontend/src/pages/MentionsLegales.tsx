  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-8 text-sm text-stone-600 dark:text-stone-400 leading-relaxed">
        <section id="editeur">
          <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-3">Éditeur du site</h2>
          <p className="mb-2">
        ...
        <section id="directeur">
          <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-3">Directeur de la publication</h2>
          <p>
        ...
        <section id="hebergement">
          <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-3">Hébergement</h2>
          <p className="mb-2">
